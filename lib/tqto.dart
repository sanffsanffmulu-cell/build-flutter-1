...
class ThanksToPageState extends State<ThanksToPage> {
  // Warna biru cerah (Blue Accent)
  final Color bgDark = const Color(0xFF0A0A1A); // Background lebih gelap kebiruan
  final Color primaryBlue = const Color(0xFF2196F3); // Biru utama
  final Color accentBlue = const Color(0xFF64B5F6); // Biru terang untuk aksen
  final Color lightBlue = const Color(0xFF90CAF9); // Biru sangat terang
  ...
  Future<void> _loadBaseUrl() async {
    try {
      ...
      setState(() {
        _errorMessage = 'Failed to load server configuration';
        _isLoading = false;
      });
    }
  }
