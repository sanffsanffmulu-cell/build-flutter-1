  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        leading: IconButton(
          icon: Icon(Icons.arrow_back_ios_new, color: lightBlue),
      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              bgDark,
              primaryDarkBlue.withOpacity(0.1), // Ini aman karena ada di build()
              bgDark,
            ],
          ),
        ),
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: primaryDarkBlue.withOpacity(0.2), // Aman di build()
                    shape: BoxShape.circle,
                    boxShadow: [
                      BoxShadow(
                        color: primaryDarkBlue.withOpacity(0.4), // Aman di build()
                        blurRadius: 20,
                      )
                    ],
                  ),
                ...
                Column(
                  children: [
                    ...
                    _buildContactButton(
                      ...
                      color: Colors.green,
                      url: "https://wa.me/62881024290921",
                    ),
                    SizedBox(height: 16),
                    _buildContactButton(
                      label: "TikTok",
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: primaryDarkBlue.withOpacity(0.1), // Aman di build()
              blurRadius: 10,
              offset: Offset(0, 4),
            ),
          ],
